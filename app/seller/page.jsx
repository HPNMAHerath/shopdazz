    ...
    <div className="py-10 flex flex-col justify-between bg-white h-[99vh] overflow-y-scroll w-full" >
            <form className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <div className="w-full flex flex-col gap-1">
                    ...
                    <select id="subCategory" className="outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500/40">
                ...
                <button className="px-8 py-2.5 text-white font-medium rounded bg-black">ADD</button>
            </form>
        </div>
  )
}
